...
// function wrapAgain(data) {
// 	if(typeof data =='object' && 'key' in data){
// 		return createWrapped(data.key, data.oldData)
// 	}
// 	return data
// }
...
console.log('wraping',pattern,data);
	// this.oldData=data
	this.wrapped=true
...
function handleError(res) {
	...
	return function (err) {
		console.log('eer',err, err.name);
		// if(err instanceof Wrapped){
